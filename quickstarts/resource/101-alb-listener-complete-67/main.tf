...
resource "alicloud_alb_listener" "default" {
  ...
  gzip_enabled      = var.gzip_enabled_var
  listener_protocol = "HTTPS"
  http2_enabled     = var.http2_enabled_var
  idle_timeout      = var.idle_timeout_var
  quic_config {
    quic_upgrade_enabled = "false"
  }

  access_log_record_customized_headers_enabled = var.access_log_record_customized_headers_enabled_var
  listener_description                         = var.listener_description_var
  listener_port                                = "67"
}
