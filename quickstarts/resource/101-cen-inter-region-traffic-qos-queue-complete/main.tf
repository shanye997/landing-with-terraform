...
resource "alicloud_cen_inter_region_traffic_qos_queue" "default" {
  inter_region_traffic_qos_queue_description = var.inter_region_traffic_qos_queue_description_var
  inter_region_traffic_qos_queue_name        = var.inter_region_traffic_qos_queue_name_var
  remain_bandwidth_percent                   = var.remain_bandwidth_percent_var
