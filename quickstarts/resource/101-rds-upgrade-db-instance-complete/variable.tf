variable "name" {
  default = "tf-exampledbpghaconfig23776"
}
...
variable "switch_time_mode_var" {
  default = "Immediate"
}

variable "db_instance_description_var" {
  default = "tf-exampleDBInstance_instance_name"
}
...
variable "tcp_connection_type_var" {
  default = "SHORT"
}
...
variable "collect_stat_mode_var" {
  default = "After"
}
