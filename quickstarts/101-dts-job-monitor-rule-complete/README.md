...
| [alicloud_dts_job_monitor_rule.default](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/dts_job_monitor_rule) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_delay_rule_time_var"></a> [delay\_rule\_time\_var](#input\_delay\_rule\_time\_var) | n/a | `string` | `"234"` | no |
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-examplecn-hangzhoudtsjobmonitorrule48158"` | no |
| <a name="input_region"></a> [region](#input\_region) | n/a | `string` | `"cn-hangzhou"` | no |
| <a name="input_region_id"></a> [region\_id](#input\_region\_id) | n/a | `string` | `"cn-hangzhou"` | no |
| <a name="input_state_var"></a> [state\_var](#input\_state\_var) | n/a | `string` | `"N"` | no |
<!-- END_TF_DOCS -->    