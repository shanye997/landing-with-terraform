...
| [alicloud_cen_transit_route_table_aggregation.default](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/cen_transit_route_table_aggregation) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-exampleCenTransitRouteTableAggregation-name5691"` | no |
<!-- END_TF_DOCS -->    