...
This example is used to create a `alicloud_oos_secret_parameter` resource.
...
| [alicloud_oos_secret_parameter.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/oos_secret_parameter) | resource |
