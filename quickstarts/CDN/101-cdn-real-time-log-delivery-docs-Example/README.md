...
This example is used to create a `alicloud_cdn_real_time_log_delivery` resource.
...
| [alicloud_cdn_real_time_log_delivery.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/cdn_real_time_log_delivery) | resource |
