...
| [alicloud_vpc_nat_ip.default](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/vpc_nat_ip) | resource |
...
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-examplecn-hangzhouvpcnatip30949"` | no |
<!-- END_TF_DOCS -->    