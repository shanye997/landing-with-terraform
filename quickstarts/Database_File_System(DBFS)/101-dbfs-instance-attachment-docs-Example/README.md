...
This example is used to create a `alicloud_dbfs_instance_attachment` resource.
...
| Name | Type |
|------|------|
| [alicloud_dbfs_instance.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/dbfs_instance) | resource |
| [alicloud_dbfs_instance_attachment.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/dbfs_instance_attachment) | resource |
