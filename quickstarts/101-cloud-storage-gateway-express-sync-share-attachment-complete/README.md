...
| [alicloud_cloud_storage_gateway_express_sync_share_attachment.default](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/cloud_storage_gateway_express_sync_share_attachment) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-examplegatewayshare79251"` | no |
