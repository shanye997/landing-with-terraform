...
This example is used to create a `alicloud_arms_addon_release` resource.
...
| Name | Type |
|------|------|
| [alicloud_arms_addon_release.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/arms_addon_release) | resource |
