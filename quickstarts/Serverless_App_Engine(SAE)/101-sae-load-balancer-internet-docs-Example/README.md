...
This example is used to create a `alicloud_sae_load_balancer_internet` resource.
...
| [alicloud_sae_load_balancer_internet.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/sae_load_balancer_internet) | resource |
