...
This example is used to create a `alicloud_sae_load_balancer_intranet` resource.
...
| [alicloud_sae_load_balancer_intranet.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/sae_load_balancer_intranet) | resource |
