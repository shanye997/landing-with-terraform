...
This example is used to create a `alicloud_sae_grey_tag_route` resource.
...
| [alicloud_sae_grey_tag_route.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/sae_grey_tag_route) | resource |
