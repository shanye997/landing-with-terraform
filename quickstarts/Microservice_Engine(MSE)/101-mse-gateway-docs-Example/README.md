...
This example is used to create a `alicloud_mse_gateway` resource.
...
| Name | Type |
|------|------|
| [alicloud_mse_gateway.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/mse_gateway) | resource |
