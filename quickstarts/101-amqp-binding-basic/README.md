...
| [alicloud_amqp_exchange.default2](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/amqp_exchange) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-example-AmqpBindingbasic473458672392148084"` | no |
<!-- END_TF_DOCS -->    