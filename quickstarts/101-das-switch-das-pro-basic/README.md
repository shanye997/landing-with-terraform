...
| Name | Type |
|------|------|
| [alicloud_das_switch_das_pro.default](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/das_switch_das_pro) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-exampleDasSwitchDasPro-name34775"` | no |
<!-- END_TF_DOCS -->    