...
| [alicloud_nlb_load_balancer_security_group_attachment.default](https://registry.terraform.io/providers/hashicorp/alicloud/latest/docs/resources/nlb_load_balancer_security_group_attachment) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-examplecn-hangzhouNlbLoadBalancerSecurityGroupAttachment11829"` | no |
<!-- END_TF_DOCS -->    