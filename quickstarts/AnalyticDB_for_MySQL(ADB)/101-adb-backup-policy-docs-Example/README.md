...
This example is used to create a `alicloud_adb_backup_policy` resource.
...
| Name | Type |
|------|------|
| [alicloud_adb_backup_policy.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/adb_backup_policy) | resource |
