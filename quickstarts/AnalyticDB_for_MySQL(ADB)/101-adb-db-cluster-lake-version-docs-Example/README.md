...
This example is used to create a `alicloud_adb_db_cluster_lake_version` resource.
...
| Name | Type |
|------|------|
| [alicloud_adb_db_cluster_lake_version.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/adb_db_cluster_lake_version) | resource |
