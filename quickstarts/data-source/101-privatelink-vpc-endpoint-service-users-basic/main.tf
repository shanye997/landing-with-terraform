resource "alicloud_ram_user" "user" {
  name         = "tf-examplePrivatelinkVpcEndpointServiceUsers7935299"
...
resource "alicloud_privatelink_vpc_endpoint_service" "default" {
  service_description    = "tf-examplePrivatelinkVpcEndpointServiceUsers7935299"
...
data "alicloud_privatelink_vpc_endpoint_service_users" "default" {
