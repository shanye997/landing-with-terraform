...
|------|-------------|------|---------|:--------:|
| <a name="input_cache_disk_size_in_gb_var"></a> [cache\_disk\_size\_in\_gb\_var](#input\_cache\_disk\_size\_in\_gb\_var) | n/a | `string` | `"100"` | no |
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-example-cloudstoragegatewaygatewaycachedisk42956"` | no |
<!-- END_TF_DOCS -->    