...
|------|-------------|------|---------|:--------:|
| <a name="input_alternate_exchange_var"></a> [alternate\_exchange\_var](#input\_alternate\_exchange\_var) | n/a | `string` | `"tf-example-AmqpExchangebasic3427262485071734742alternate_exchange"` | no |
| <a name="input_internal_var"></a> [internal\_var](#input\_internal\_var) | n/a | `string` | `"false"` | no |
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"tf-example-AmqpExchangebasic3427262485071734742"` | no |
<!-- END_TF_DOCS -->    