...
This example is used to create a `alicloud_log_dashboard` resource.
...
| Name | Type |
|------|------|
| [alicloud_log_dashboard.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/log_dashboard) | resource |
