...
This example is used to create a `alicloud_log_oss_shipper` resource.
...
| Name | Type |
|------|------|
| [alicloud_log_oss_shipper.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/log_oss_shipper) | resource |
